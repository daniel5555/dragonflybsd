...
#endif
#ifdef BYFOUR
   local unsigned long crc32_zlib_little((unsigned long,
                        const unsigned char FAR *, unsigned));
   local unsigned long crc32_zlib_big((unsigned long,
                        const unsigned char FAR *, unsigned));
#  define TBLS 8
#else
#  define TBLS 1
...
/* ========================================================================= */
unsigned long crc32_zlib(crc, buf, len)
    unsigned long crc;
...
/* ========================================================================= */
uLong crc32_zlib_combine(crc1, crc2, len2)
    uLong crc1;
    uLong crc2;
    z_off_t len2;
{
...
uLong crc32_zlib_combine64(crc1, crc2, len2)
    uLong crc1;
    uLong crc2;
    z_off64_t len2;
{
